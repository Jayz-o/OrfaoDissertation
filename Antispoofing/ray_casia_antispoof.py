...
AUG_FOLDER_COMBINATIONS = [
    "A@N1,A@R1,A@W1,A@C1",
    "A@N2,A@R2,A@W2,A@C2",
    "A@N1,A@N2,A@HR_N,A@R1,A@R2,A@HR_R",
    "A@HR_N,A@HR_R,A@HR_W,A@HR_C",
    "A@N1,A@N2,A@HR_N,A@W1,A@W2,A@HR_W",
    "A@N1,A@N2,A@HR_N,A@C1,A@C2,A@HR_C",
    "A@HR_N,A@HR_W,A@HR_C,A@HR_R,A@N1,A@N2,A@R1,A@R2,A@W1,A@W2,A@C1,A@C2",
]
