...
ATTACK_TYPE_COMBINATIONS = [
     'KF@ASUS-IP7P-IPP2017,KF@N',
     'KF@ASUS-IP7P-SGS8,KF@N',
     'KF@ASUS-IPP2017-SGS8,KF@N',
     'KF@IP7P-IPP2017-SGS8,KF@N',
     'KF@P,KF@N',
     'KF@R,KF@N',
]
...
if __name__ == '__main__':
    ...
    original_dataset_name="SIW"
    aug_dataset_name = "SIW_KF"
    ...
    antispoof_setup(dataset_name, dataset_csv_name, get_siw_train_frame_func, get_siw_protocol_frame_dic,
                    ...
                    original_dataset_name=original_dataset_name, must_use_normal_only=must_use_normal_only, use_hsv=use_hsv)
